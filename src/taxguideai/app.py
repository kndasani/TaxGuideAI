...
def inject_knowledge(persona_type):
    ...
    if persona_type == "SALARY": return get_pdf_file(os.path.join(data_dir, "salary_rules.pdf"))
    elif persona_type == "BUSINESS": return get_pdf_file(os.path.join(data_dir, "freelancer_rules.pdf"))
    elif persona_type == "CAPITAL_GAINS": return get_pdf_file(os.path.join(data_dir, "capital_gains.pdf"))
    return None
